...
public class Config {
	...
	private Config() {
		...
		properties.put(DO_TRANSACTIONS, new Boolean(false));
		...
		properties.put(MEMCACHED_ADDRESS, "127.0.0.1");
		...
		properties.put(MEMGET, new Double(0.95));
		...
		properties.put(MEMUPDATE, new Double(0.05));
