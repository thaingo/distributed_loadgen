 ...
 */
public class MemcachedImpl extends Memcached {
	Memcached _db;
	Measurements _measurements;

	public MemcachedImpl(Memcached memcached) {
		_db = memcached;
	...
	public int get(String key, Object value) {
		...
		//int res = 0;
		long en = System.nanoTime();
		//long en = ((SpymemcachedClient)_db).qGet(key, value);
		//System.out.println(en + " : " + st + " : " + (en - st));
		if (en > 0) {
